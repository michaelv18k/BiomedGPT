...
user_dir=/kaggle/working/BiomedGPT/module
bpe_dir=/kaggle/working/BiomedGPT/utils/BPE

# val or test
split=$1

data_dir=/kaggle/working/BiomedGPT/datasets/finetuning/vqa-rad
...
for scale in ${Scale[@]}; do
    ...
    path=/content/drive/MyDrive/checkpoint_bestt.pt
